...
output = '''=========================================================
    KNNPRED - Authentication test at {now}
=========================================================
   Request done at "/knnpred" with username={username1} and password={password1} :
      expected result = 200
      actual result = {status_code1}
      ==>  {test_status1}
      {la_reponse1}
   Request done at "/knnpred" with username={username2} and password={password2} :
      expected result = 200
      actual result = {status_code2}
      ==>  {test_status2}
      {la_reponse2}
   Request done at "/knnpred" with username={username3} and password={password3} :
      expected result = 200
      actual result = {status_code3}
      ==>  {test_status3}
      {la_reponse3}
   Request done at "/knnpred" with username={username4} and password={password4} :
      expected result = 401
